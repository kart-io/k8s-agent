        ...
        vxetable.renderer.mixin({
          ...
          ASelect: {
            renderEdit: function renderEdit(renderOpts, params) {
              var options = renderOpts.options, optionGroups = renderOpts.optionGroups;
              var row = params.row, column = params.column;
              var attrs = renderOpts.attrs;
              var cellValue = _xeUtils["default"].get(row, column.field);
              ...
              if (optionGroups) {
                return [(0, _vue.h)((0, _vue.resolveComponent)("a-select"), _objectSpread(_objectSpread(_objectSpread({}, props), attrs), {}, {
            ...
            renderFilter: function renderFilter(renderOpts, params) {
              var _renderOpts$options3 = renderOpts.options, options = _renderOpts$options3 === void 0 ? [] : _renderOpts$options3, optionGroups = renderOpts.optionGroups, _renderOpts$optionGro2 = renderOpts.optionGroupProps, optionGroupProps = _renderOpts$optionGro2 === void 0 ? {} : _renderOpts$optionGro2;
              var groupOptions = optionGroupProps.options || "options";
              var column = params.column;
              var attrs = renderOpts.attrs;
              return [(0, _vue.h)("div", {
            ...
            renderItemContent: function renderItemContent(renderOpts, params) {
              var _renderOpts$options4 = renderOpts.options, options = _renderOpts$options4 === void 0 ? [] : _renderOpts$options4, optionGroups = renderOpts.optionGroups;
              var data = params.data, field = params.field;
              var attrs = renderOpts.attrs;
              var itemValue = _xeUtils["default"].get(data, field);
              ...
              if (optionGroups) {
                return [(0, _vue.h)((0, _vue.resolveComponent)("a-select"), _objectSpread(_objectSpread(_objectSpread({}, attrs), props), {}, {
                  options: optionGroups
                }, ons))];
              }
              return [(0, _vue.h)((0, _vue.resolveComponent)("a-select"), _objectSpread(_objectSpread(_objectSpread({}, attrs), props), {}, {
