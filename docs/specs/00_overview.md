...
本文档是系统总览。完整的系统需求规格说明书位于 [ai_agent.md](../ai_agent.md) (5000+行完整文档)。
...
| 文档 | 说明 | 主要读者 |
|------|------|----------|
| [ai_agent.md](../ai_agent.md) | **完整系统需求规格说明书** - 需求、架构、数据模型、部署、安全 (5000+行) | 所有角色 |
| [REQUIREMENTS.md](../REQUIREMENTS.md) | **需求文档索引** - 功能需求(FR-1~FR-18)、非功能需求(NFR-1~NFR-29) | 产品经理、测试工程师 |
| [README.md](../README.md) | **文档中心导航** - 按角色和任务的文档导航 | 所有角色 |

### 🎯 专题文档 (快速访问)

| 文档 | 说明 | 对应ai_agent.md章节 |
|------|------|---------------------|
| [02_architecture.md](./02_architecture.md) | **系统架构设计** | 第5章 |
| [03_data_models.md](./03_data_models.md) | **核心数据模型** | 第6章 |
| [04_deployment.md](./04_deployment.md) | **部署与配置** | 第7章 |
| [05_operations.md](./05_operations.md) | **运维与监控** | 第8-9章 |
| [06_microservices.md](./06_microservices.md) | **微服务架构详细设计** | 第5章扩展 |
| [07_k8s_event_watcher.md](./07_k8s_event_watcher.md) | **K8s事件监听实现** | 第3章扩展 |

### 📚 安全与规划

| 文档 | 说明 | 对应ai_agent.md章节 |
|------|------|---------------------|
| **安全设计** | [ai_agent.md 第10章](../ai_agent.md#10-安全考量) | 第10章 |
| **路线图与FAQ** | [ai_agent.md 第11-12章](../ai_agent.md#11-迭代路线图-roadmap) | 第11-12章 |
...
> **阅读提示**: 本章节定义了文档中使用的核心术语。建议在阅读系统概述前先浏览本节，以便更好地理解系统功能描述。

| 术语 | 简化定义 | 详细文档 |
|------|----------|----------|
| **AI Agent** | 基于大语言模型的智能诊断代理，能够自主执行运维任务 | [完整定义](../ai_agent.md#附录-a-术语表-glossary) |
| **MCP (Model Context Protocol)** | 用于AI模型与外部工具安全交互的协议 | [完整定义](../ai_agent.md#附录-a-术语表-glossary) |
| **RAG (Retrieval-Augmented Generation)** | 检索增强生成，结合知识库检索和LLM生成的技术 | [完整定义](../ai_agent.md#附录-a-术语表-glossary) |
| **诊断任务 (Diagnostic Task)** | 由告警或事件触发的单次问题排查流程 | [完整定义](../ai_agent.md#附录-a-术语表-glossary) |
| **工具注册表 (Tool Registry)** | 管理Agent可执行命令的中央配置系统 | [完整定义](../ai_agent.md#附录-a-术语表-glossary) |
...
| **Alertmanager** | Prometheus生态系统的告警管理组件 | [官方文档](https://prometheus.io/docs/alerting/latest/alertmanager/) |

> 💡 **提示**: 本表提供简化定义以便快速理解。完整的学术定义、技术细节和使用示例请参见 [ai_agent.md 附录A 术语表](../ai_agent.md#附录-a-术语表-glossary)。
