...
func (a *ProgressAgent) Execute(ctx context.Context, input *core.AgentInput) (*core.AgentOutput, error) {
	...
	// 收集所有进度和结果
	reader := streamOutput.(*stream.Reader)
...
func (a *ProgressAgent) processWithProgress(ctx context.Context, input *core.AgentInput, writer *stream.Writer) {
	defer writer.Close()
...
func NewProgressTracker(total int64, writer *stream.Writer, config *ProgressConfig) *ProgressTracker {
